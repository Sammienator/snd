  ...
  return (
    <div id='about' className='w-full bg-white py-8 px-4 ' >
       <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        <img className='w-[500px] mx-auto my-4 h-[300px] rounded-lg hover:scale-105 duration-500 ease-in-out'  src={about} alt="/" />
        <div className='flex flex-col justify-center'>
          <p className='text-[white] font-bold text-5xl'> WHAT DO WE OFFER?</p>
       ...
       <div className='flex flex-col'>
        <h1 className='font-bold underline mt-10 text-white shadow-lg uppercase italic text-3xl'>
       ...
       <div className=" flex flex-col p-6 mx-auto mt-4 m-8  md:space-y-0 md:flex-row italic text-black font-bold" >
