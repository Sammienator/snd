               ...
               <div className=" flex flex-col space-y-8 md:w-1/2">
                   <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                       <div className="pt-12">
                           ...
                           <button className='bg-[aqua] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black hover:scale-105 duration-500 ease-in-out'> Price: 2/= per gram  </button>
                       </div>
                   </div>
               </div>
                ...
                <div className=" flex flex-col space-y-8 md:w-1/2">
                    <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                        <div className="pt-12">
                            ...
                            <button className='bg-[aqua] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black hover:scale-105 duration-500 ease-in-out'> Price: 1.8/= per gram  </button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className=" flex flex-col space-y-8 md:w-1/2">
                    <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row">
                        <div className="pt-12">
                            ...
                            The bar will be available for purchase on 25th of February @ 2ksh per gram
                            </p>
                            <button className='bg-[aqua] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black hover:scale-105 duration-500 ease-in-out'> Price: 2/= per gram  </button>
                        </div>
                    </div>
